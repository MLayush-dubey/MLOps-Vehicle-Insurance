...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            print("------------------------------------------------------------------------------------------------")
            self.proj1_estimator.save_model(from_file = self.model_evaluation_artifact.trained_model_path)  #if modelevaluation decides that new model is better then this pushes that new model
