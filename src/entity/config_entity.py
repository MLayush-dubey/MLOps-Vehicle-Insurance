...
class ModelTrainerConfig:
    ...
    _n_estimators: str = MODEL_TRAINER_N_ESTIMATORS  #hamesha agar config values rehte h toh _ se prefix krte h
    _min_samples_split: str = MODEL_TRAINER_MIN_SAMPLES_SPLIT
    _min_samples_leaf: str = MODEL_TRAINER_MIN_SAMPLES_LEAF
    _max_depth: str = MIN_SAMPLES_SPLIT_MAX_DEPTH
    _criterion: str = MIN_SAMPLES_SPLIT_CRITERION
    _random_state: str = MIN_SAMPLES_SPLIT_RANDOM_STATE
